...
function Ut(e) {
  if (!e[ar]) {
    ...
    n === null || n[ar] || ((n[ar] = !0), jl("selectionchange", !1, n));
  }
}
function Zs(e, n, t, r) {
  switch (Os(n)) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = jt(a, f)), v != null && k.push($t(a, v, d)))),
            F)
          )
            break;
          a = a.return;
...
function Lu(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    _r(e, n), oa(n, t, r), xo(n, t, r, l), (r = !0);
  else if (e === null) {
    var i = n.stateNode,
      u = n.memoizedProps;
    i.props = u;
...
function Wa(e, n) {
  ...
  if (n !== 0) {
    if (
      (n === 2 && ((l = uo(e)), l !== 0 && ((r = l), (n = Io(e, l)))), n === 1)
    )
...
function Jr(e, n) {
  ...
  while (!0);
  if ((ai(), (j = t), (Xr.current = r), K !== null)) throw Error(y(261));
  return (J = null), (b = 0), X;
}
function vd() {
  for (; K !== null; ) Ya(K);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Jo(n, t | 1), pe(n, Q()), !(j & 6) && ((rt = Q() + 500), hn()));
      }
      break;
    case 13:
      Ln(function () {
...
const Rd = "/assets/ht1-lp-kMH3eyJj.png",
  jd = "/assets/arrow-src2-awQsBjax.png",
  Od = "/assets/gh-logo-dy8VsXC1.png",
  Md = "/assets/LI-In-Bug-hwbFwRG2.png";
function Dd() {
  return L.jsxs(L.Fragment, {
    children: [
        ...
        children: [
          L.jsxs("div", {
            ...
            children: [
              ...
              L.jsx("p", {
                className: "title headingp",
                children: "Cloud Engineer - Mentor",
              }),
              L.jsx("p", { className: "headingp", children: "Chicago, IL" }),
            ],
          }),
          L.jsxs("div", {
            className: "section",
            children: [
              L.jsx("img", { className: "hsimage", src: Rd }),
              L.jsxs("p", {
                className: "headingp",
                children: [
                  L.jsx("img", { className: "wwimg", src: jd }),
                  L.jsx("a", {
                    href: "https://www.linkedin.com/in/lenny-jent/",
                    target: "_BLANK",
      ...
      L.jsxs("div", {
        className: "detailsSectionRow",
        children: [
          L.jsxs("div", {
            className: "pjtDetailsDiv",
            children: [
              L.jsx("h2", { children: "Recent work..." }),
              L.jsxs("p", {
                children: [
                  L.jsx("b", { children: "Project Item:" }),
                  " A Command Generator Website - for Faster PowerShell Tasks",
                ],
              }),
              L.jsxs("p", {
                children: [
                  L.jsx("b", { children: "Summary" }),
                  " - A simple collection of web pages that provide HTML forms - which generate PowerShell command text based on form content. This is a resource for team members to quickly perform common PowerShell tasks.",
                ],
              }),
              L.jsxs("p", {
                children: [
                  L.jsx("b", { children: "Resources: " }),
                  L.jsx("a", {
                    href: "https://www.powershelldemos.com/get-aduser-helper.html",
                    target: "_blank",
                    children: "⮕ Here",
                  }),
                ],
              ...
              L.jsxs("p", {
                children: [
                  L.jsx("b", { children: "Project Item:" }),
                  " A quick Active Directory Lab Setup - especially for testing scripts",
                ],
              }),
              L.jsxs("p", {
                children: [
                  L.jsx("b", { children: "Summary" }),
                  " - A collection of resources to create a simple Active Directory lab within an AWS VPC. These steps generate a fresh, and default installation of a new AD Forest - so additional tasks are needed if custom or production data replication is needed.",
                ],
              }),
              L.jsxs("p", {
                children: [
                  L.jsx("b", { children: "Resources: " }),
                  L.jsx("a", {
                    href: "https://github.com/lenny-j/lenny-j.github.io/tree/main/exhibits/AWS-AD-Lab",
                    target: "_blank",
                    children: "⮕ Here",
                  }),
                ],
          ...
          L.jsxs("div", {
            className: "connectChisDiv",
            children: [
              L.jsx("a", {
                href: "https://www.linkedin.com/in/lenny-jent/",
                target: "_blank",
                children: L.jsx("img", { className: "chimg", src: Md }),
              }),
              L.jsx("a", {
                href: "https://github.com/lenny-j",
                target: "_blank",
                children: L.jsx("img", { className: "chimg", src: Od }),
              }),
            ],
          }),
        ],
...
Wl.createRoot(document.getElementById("root")).render(
  L.jsx(wc.StrictMode, { children: L.jsx(Dd, {}) })
);
